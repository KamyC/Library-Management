...
<html>
<head>
    <title>Edit Reader Info《 ${readerInfo.readerId}》</title>
...
<div class="col-xs-6 col-md-offset-3" style="position: relative;">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Edit Reader Info《 ${readerInfo.readerId}》</h3>
        </div>
        <div class="panel-body">
            <form action="reader_edit_do.html?readerId=${readerInfo.readerId}" method="post" id="readeredit" >
                ...
                <input type="submit" value="Comfirm" class="btn btn-success btn-sm" class="text-left">
                <script>
