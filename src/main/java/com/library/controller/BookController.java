...
public class BookController {
    ...
    public ModelAndView queryBookDo(String searchWord) {
        if (bookService.matchBook(searchWord)) {
            ...
            return new ModelAndView("admin_books", "error", "No Matching books");
        }
    }
    ...
    public ModelAndView readerQueryBookDo(String searchWord) {
        if (bookService.matchBook(searchWord)) {
            ...
            return new ModelAndView("reader_books", "error", "No Matching books");
        }
    }
    ...
    public String addBookDo(@RequestParam(value = "pubstr") String pubstr, Book book, RedirectAttributes redirectAttributes) {
        ...
        if (bookService.addBook(book)) {
            redirectAttributes.addFlashAttribute("succ", "Adding Book Succeed");
        } else {
            redirectAttributes.addFlashAttribute("error", "Adding Book Fail");
        }
    ...
    public String bookEditDo(@RequestParam(value = "pubstr") String pubstr, Book book, RedirectAttributes redirectAttributes) {
        ...
        if (bookService.editBook(book)) {
            redirectAttributes.addFlashAttribute("succ", "Revise Succeeds！");
        } else {
            redirectAttributes.addFlashAttribute("error", "Revise Fails！");
        }
        return "redirect:/admin_books.html";
    }
